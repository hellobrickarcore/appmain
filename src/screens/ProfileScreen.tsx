            ...
            <div className="flex-1 px-5 space-y-8 pb-32 pt-6 overflow-y-auto no-scrollbar relative z-10">
                ...
                <div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-6 grid grid-cols-2 gap-6 backdrop-blur-xl">
                        ...
                        {/* Level Progress */}
                        <div className="flex items-center gap-4 col-span-2 bg-slate-900/80 p-4 rounded-2xl border border-white/5 mt-2">
                            <div className="w-12 h-12 bg-yellow-500/20 rounded-full flex items-center justify-center shrink-0">
                                <Trophy className="w-6 h-6 text-yellow-500" />
                            </div>
                            <div className="flex-1">
                                <span className="block font-black text-lg text-white mb-1">Level {userStats.level}</span>
                                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                                    <div className="bg-yellow-500 h-full rounded-full" style={{ width: `${(userStats.xp % 1000) / 10}%` }} />
                                </div>
                            </div>
                            <div className="text-right shrink-0">
                                <span className="block text-xs text-slate-400 font-bold">{1000 - (userStats.xp % 1000)}</span>
                                <span className="text-[8px] text-slate-500 uppercase tracking-widest">To Next</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* HOW TO EARN XP */}
                <div>
                    <h2 className="text-lg font-bold mb-4 text-white">How to Earn XP</h2>
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-6 space-y-4 backdrop-blur-xl">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <h3 className="text-white font-bold text-sm">Scan Bricks</h3>
                                <p className="text-slate-400 text-xs">Find new pieces with AR</p>
                            </div>
                            <span className="text-orange-400 font-black">+10 XP</span>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <h3 className="text-white font-bold text-sm">Train AI</h3>
                                <p className="text-slate-400 text-xs">Correct predictions</p>
                            </div>
                            <span className="text-green-400 font-black">+50 XP</span>
                        </div>
                        <div className="w-full h-px bg-white/5" />
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <h3 className="text-white font-bold text-sm">Play Puzzles</h3>
                                <p className="text-slate-400 text-xs">Complete daily quests</p>
                            </div>
