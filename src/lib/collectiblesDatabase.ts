...
export const MASTER_SETS: LegoSetItem[] = [
  {
    ...
    demandScore: 10,
    rating: 'Blue Chip',
    imageUrl: 'https://img.bricklink.com/ItemImage/SN/0/75192-1.png',
    isRetired: false,
  ...
  },
  {
    ...
    demandScore: 8,
    rating: 'Grail',
    imageUrl: 'https://img.bricklink.com/ItemImage/SN/0/75252-1.png',
    isRetired: true,
    setId: 'set-star-wars-ucs',
    primaryMarketplace: 'BrickLink / BrickEconomy Aggregate',
  ...
  },
  {
    ...
    demandScore: 10,
    rating: 'Strong Buy',
    imageUrl: 'https://img.bricklink.com/ItemImage/SN/0/10316-1.png',
    isRetired: false,
    primaryMarketplace: 'BrickLink / BrickEconomy Aggregate',
  ...
  },
  {
    ...
    demandScore: 9,
    rating: 'Blue Chip',
    imageUrl: 'https://img.bricklink.com/ItemImage/SN/0/10305-1.png',
    isRetired: false,
    primaryMarketplace: 'BrickLink / BrickEconomy Aggregate',
  ...
  },
  {
    ...
    demandScore: 9,
    rating: 'Blue Chip',
    imageUrl: 'https://img.bricklink.com/ItemImage/SN/0/10294-1.png',
    isRetired: false,
    primaryMarketplace: 'BrickLink / BrickEconomy Aggregate',
...
export const MASTER_MINIFIGS: MinifigureItem[] = [
  ...
  },
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://img.bricklink.com/ItemImage/MN/0/col160.png',
  ...
  },
  {
    ...
    demandScore: 9,
    rating: 'Strong Buy',
    imageUrl: 'https://img.bricklink.com/ItemImage/MN/0/sw0603.png',
  ...
  },
  {
    ...
    demandScore: 10,
    rating: 'Hold',
    imageUrl: 'https://img.bricklink.com/ItemImage/MN/0/sw0445.png',
  ...
  },
  {
    ...
    demandScore: 9,
    rating: 'Strong Buy',
    imageUrl: 'https://img.bricklink.com/ItemImage/MN/0/sw0522.png',
  ...
  },
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://img.bricklink.com/ItemImage/MN/0/sw0450.png',
  ...
  },
  {
    ...
    demandScore: 9,
    rating: 'Strong Buy',
    imageUrl: 'https://img.bricklink.com/ItemImage/MN/0/sw0196.png',
...
export const MASTER_MTG: CardItem[] = [
  ...
  },
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://cards.scryfall.io/large/front/e/c/ec8e815e-a270-4d40-b6f1-a162aa3aa84f.jpg',
    cardNumber: '001/001',
...
export const MASTER_ONE_PIECE: CardItem[] = [
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://images.weserv.nl/?url=www.tcgfish.com/images/one-piece/OP01-120.webp&w=400&output=jpg',
    cardNumber: 'OP01-120',
...
export const MASTER_LORCANA: CardItem[] = [
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://images.weserv.nl/?url=product.dragonshield.com/wp-content/uploads/2023/08/LRC-TFC-207.jpg&w=400&output=jpg',
    cardNumber: '207/204',
...
export const MASTER_SPORTS: SportsCardItem[] = [
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://images.weserv.nl/?url=i.ebayimg.com/images/g/hCEAAOSwjPVht4f~/s-l1600.jpg&w=400&output=jpg',
    cardNumber: '#57',
...
export const MASTER_MOCS: MocBuildItem[] = [
  {
    ...
    demandScore: 9,
    rating: 'Strong Buy',
    imageUrl: 'https://img.bricklink.com/ItemImage/SN/0/10497-1.png',
    isRetired: false,
    pieceCount: 380,
    matchPercentage: 92,
    difficulty: 'Medium',
...
export const MASTER_EXPANSION_SETS: ExpansionSet[] = [
  ...
  },
  {
    ...
    totalValue: 775.93,
    releaseYear: 2024,
    logoUrl: 'https://img.bricklink.com/ItemImage/MN/0/sw0450.png',
