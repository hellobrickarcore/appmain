...
export const MASTER_MTG: CardItem[] = [
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://images.unsplash.com/photo-1606166325683-e6deb6979b0c?q=80&w=400&auto=format&fit=crop',
    cardNumber: 'LEA-001',
...
export const MASTER_YUGIOH: CardItem[] = [
  {
    ...
    demandScore: 10,
    rating: 'Grail',
    imageUrl: 'https://images.unsplash.com/photo-1620336655055-088d06e36bf0?q=80&w=400&auto=format&fit=crop',
    cardNumber: 'LOB-001',
...
export const MASTER_EXPANSION_SETS: ExpansionSet[] = [
  {
    ...
    totalValue: 8017.72,
    releaseYear: 2021,
    logoUrl: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/6.png',
  ...
  },
  {
    ...
    totalValue: 18450.00,
    releaseYear: 2024,
    logoUrl: 'https://images.unsplash.com/photo-1585366119957-e9730b6d0f60?q=80&w=400&auto=format&fit=crop',
